...
function BottomNav({ screen, setScreen, bs }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { padding: "0 10px 10px", flexShrink: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", background: bs.surface, backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", borderRadius: 999, border: `1px solid ${bs.borderStrong}`, padding: "5px 8px", boxShadow: "0 8px 32px rgba(0,0,0,0.45)" } }, navBtns.map((btn) => {
    if (btn.id === "__fab") return /* @__PURE__ */ React.createElement("div", { key: "fab", style: { flex: 1, display: "flex", justifyContent: "center" } }, /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: () => setScreen("upload"),
        style: { width: 46, height: 46, borderRadius: 14, background: bs.grad, border: "none", cursor: "pointer", display: "grid", placeItems: "center", boxShadow: bs.glow, transform: "translateY(-10px)", transition: "transform .2s" },
      ...
      /* @__PURE__ */ React.createElement("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "white", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("line", { x1: "12", y1: "5", x2: "12", y2: "19" }), /* @__PURE__ */ React.createElement("line", { x1: "5", y1: "12", x2: "19", y2: "12" }))
    ));
...
function DesktopSidebar({ screen, setScreen, bs }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { width: 230, background: bs.surface, borderRight: `1px solid ${bs.border}`, display: "flex", flexDirection: "column", height: "100%", padding: "18px 12px", flexShrink: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 9, marginBottom: 28, paddingLeft: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 36, height: 36, borderRadius: 12, background: bs.grad, display: "grid", placeItems: "center", flexShrink: 0, boxShadow: bs.glow } }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 40 40", width: "20", height: "20", fill: "white" }, /* @__PURE__ */ React.createElement("ellipse", { cx: "20", cy: "26", rx: "10", ry: "8" }), /* @__PURE__ */ React.createElement("ellipse", { cx: "9", cy: "16", rx: "4", ry: "5.5" }), /* @__PURE__ */ React.createElement("ellipse", { cx: "31", cy: "16", rx: "4", ry: "5.5" }), /* @__PURE__ */ React.createElement("ellipse", { cx: "14", cy: "8", rx: "3.5", ry: "5" }), /* @__PURE__ */ React.createElement("ellipse", { cx: "26", cy: "8", rx: "3.5", ry: "5" }))), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "Bricolage Grotesque,sans-serif", fontSize: 20, fontWeight: 800, letterSpacing: "-0.04em", background: bs.grad, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" } }, "B Social")), /* @__PURE__ */ React.createElement("nav", { style: { flex: 1, display: "flex", flexDirection: "column", gap: 2 } }, navItems.map((item) => /* @__PURE__ */ React.createElement(
    ...
    {
      onClick: () => setScreen("upload"),
      style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 8, padding: "12px", borderRadius: 14, border: "none", background: bs.grad, color: "#fff", fontSize: 13.5, fontWeight: 700, cursor: "pointer", fontFamily: "inherit", marginBottom: 14, boxShadow: bs.glow, transition: "opacity .15s" },
...
function App() {
  ...
  const dt = (iso, o) => {
    try {
      return new Date(iso).toLocaleDateString("es-US", o);
    } catch (e) {
      return "";
    }
  };
  ...
  const refresh = async () => {
    try {
      const d = await apiCall("get", {});
      if (d && d.ok) {
        applyData(d);
        if (d.me && d.me.username) {
          BSDATA.me = { ...BSDATA.me, username: d.me.username, name: d.me.display_name || d.me.username, city: d.me.city || "", initials: (d.me.username || "?").slice(0, 2).toUpperCase(), color: d.me.avatar_color || BSDATA.me.color, bio: d.me.bio || "", verified: d.me.username === "brightpuppy" };
        }
        setMe(d.me || null);
  ...
  useEffect(() => {
    if (window.supabase && !window._bsSb) {
      try {
        window._bsSb = supabase.createClient(SU, ANON);
      } catch (e) {
      }
    }
    refresh();
  ...
  window.BSAUTH = {
    ...
    follow: async (target, unfollow) => {
      const d = await apiCall("follow", { target_email: target, unfollow });
      if (d && d.ok) await refresh();
      return d;
    }
  };
