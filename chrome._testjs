...
function Header({ overDark }) {
  ...
  return /* @__PURE__ */ React.createElement("header", { className: klass }, /* @__PURE__ */ React.createElement("div", { className: "container hdr-row" }, /* @__PURE__ */ React.createElement("a", { href: "#top", className: "hdr-logo", "aria-label": "BPuppy" }, /* @__PURE__ */ React.createElement("img", { src: overDark && !scrolled ? "assets/logo-clean-light.png" : "assets/logo-clean.png", alt: "BPuppy logo" }), /* @__PURE__ */ React.createElement("span", { className: "wm notranslate" }, "Bright Puppy")), /* @__PURE__ */ React.createElement("nav", { className: "nav" }, /* @__PURE__ */ React.createElement("a", { href: "Home.html" }, t(["Inicio", "Home"])), pv["Cachorros"] !== false && /* @__PURE__ */ React.createElement(NavItem, { label: t(STRINGS.nav.puppies), href: "Cachorros.html", items: cachItems }), pv["Gatos"] !== false && /* @__PURE__ */ React.createElement(NavItem, { label: t(["Gatos", "Cats"]), href: "Gatos.html", items: gatosItems }), /* @__PURE__ */ React.createElement("a", { href: "Financiamiento.html" }, t(["Financiamiento", "Financing"])), pv["Tienda"] !== false && /* @__PURE__ */ React.createElement("a", { href: "Tienda.html" }, t(["Tienda", "Shop"])), pv["Grooming"] !== false && /* @__PURE__ */ React.createElement("a", { href: "Grooming.html" }, /* @__PURE__ */ React.createElement("span", { className: "notranslate" }, "Grooming")), /* @__PURE__ */ React.createElement(NavItem, { label: /* @__PURE__ */ React.createElement("span", { className: "notranslate" }, "Media"), href: "Media.html", items: mediaItems.length > 1 ? mediaItems : void 0 }), pv["Nosotros"] !== false && /* @__PURE__ */ React.createElement(NavItem, { label: t(["Nosotros", "About"]), href: "Nosotros.html", items: [
...
function Footer() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("footer", { className: "foot notranslate", translate: "no" }, /* @__PURE__ */ React.createElement("div", { className: "container foot-row" }, /* @__PURE__ */ React.createElement("div", { className: "foot-logo" }, /* @__PURE__ */ React.createElement("img", { src: "assets/logo-clean.png", alt: "" }), /* @__PURE__ */ React.createElement("span", null, "BPuppy")), /* @__PURE__ */ React.createElement("p", null, t(STRINGS.foot.rights)), /* @__PURE__ */ React.createElement("div", { className: "foot-links" }, /* @__PURE__ */ React.createElement("a", { href: "Garantia.html" }, t(["Garant\xEDa", "Guarantee"])), /* @__PURE__ */ React.createElement("a", { href: "#" }, t(STRINGS.foot.health)), /* @__PURE__ */ React.createElement("a", { href: "#" }, t(STRINGS.foot.privacy)), /* @__PURE__ */ React.createElement("a", { href: "#" }, t(STRINGS.foot.terms)))), /* @__PURE__ */ React.createElement("div", { className: "container", style: { marginTop: 14, paddingTop: 14, borderTop: "1px solid rgba(45,36,33,0.08)", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 } }, /* @__PURE__ */ React.createElement("a", { href: "https://maps.google.com/?q=5604+Kalogridis+Rd+Haines+City+FL+33844", target: "_blank", rel: "noreferrer", style: { fontSize: 13, color: "var(--ink-2)", textDecoration: "none", display: "flex", alignItems: "center", gap: 6 } }, "\u{1F4CD} 5604 Kalogridis Rd, Haines City, FL 33844"), /* @__PURE__ */ React.createElement("a", { href: "https://www.google.com/maps?cid=10300429461328700851", target: "_blank", rel: "noreferrer", className: "btn btn-ghost", style: { fontSize: 13, gap: 6 } }, "\u2B50 ", t(["Dejar resena en Google", "Leave a Google review"])))), show && /* @__PURE__ */ React.createElement(
    "button",
    {
...
function ComingSoon({ pageName }) {
  ...
  } }, pageName ? `${pageName} llega pronto` : "Esta p\xE1gina est\xE1 en preparaci\xF3n"), /* @__PURE__ */ React.createElement("p", { style: { color: "var(--ink-2,#6B5A4E)", lineHeight: 1.65, marginBottom: 32, fontSize: 15 } }, "Estamos trabajando para traerte la mejor experiencia. Gracias por tu paciencia."), /* @__PURE__ */ React.createElement("a", { href: "Home.html", style: {
    display: "inline-flex",
    alignItems: "center",
    gap: 8,
