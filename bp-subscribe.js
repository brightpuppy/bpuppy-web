  ...
  function build(footer) {
    ...
    band.innerHTML =
      '<div style="max-width:640px;margin:0 auto;text-align:center">' +
        '<div style="font-family:\'Bricolage Grotesque\',system-ui,sans-serif;font-weight:800;font-size:clamp(20px,4vw,27px);color:' + INK + ';letter-spacing:-0.02em;margin:0 0 6px">' + t("Recibe cachorros disponibles y ofertas", "Get available puppies & offers") + '</div>' +
        '<p style="color:' + MUT + ';font-size:14.5px;line-height:1.55;margin:0 auto 16px;max-width:46ch">' + t("Suscríbete y te enviamos cachorros nuevos, novedades y descuentos — sin llenarte la bandeja.", "Subscribe and we’ll send you new puppies, news and discounts — without flooding your inbox.") + '</p>' +
        '<form id="bp-sub-form" style="display:flex;gap:8px;flex-wrap:wrap;justify-content:center;max-width:500px;margin:0 auto">' +
          '<input id="bp-sub-name" placeholder="' + t("Tu nombre (opcional)", "Your name (optional)") + '" autocomplete="name" style="flex:1;min-width:130px;padding:13px 15px;border-radius:12px;border:1px solid ' + LINE + ';font-size:15px;font-family:inherit;background:#fff;color:' + INK + ';outline:none">' +
          '<input id="bp-sub-email" type="email" placeholder="' + t("Tu correo", "Your email") + '" autocomplete="email" required style="flex:2;min-width:170px;padding:13px 15px;border-radius:12px;border:1px solid ' + LINE + ';font-size:15px;font-family:inherit;background:#fff;color:' + INK + ';outline:none">' +
