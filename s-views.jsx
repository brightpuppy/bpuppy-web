      ...
      <div style={{ flex:1, position:'relative', overflow:'hidden' }}>
        ...
        <div style={{ position:'absolute', bottom:0, left:0, right:0, padding:'28px 26px 34px' }}>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:6 }}>
            ...
            <span style={{ fontSize:12, color:'rgba(255,255,255,0.5)', fontWeight:500 }}>+12,000 dueños activos</span>
          </div>
        </div>
      </div>
      <div style={{ background:BS.surface, padding:'22px 22px 34px', display:'flex', flexDirection:'column', gap:10 }}>
        <button onClick={onLogin} className="bs-btn" style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:10, padding:'14px', borderRadius:14, border:`1.5px solid ${BS.borderStrong}`, background:BS.surface2, fontSize:14.5, fontWeight:600, color:BS.ink, cursor:'pointer', fontFamily:'inherit' }}>
        ...
        <button onClick={onLogin} className="bs-btn" style={{ padding:'14px', borderRadius:14, border:'none', background:BS.grad, fontSize:14.5, fontWeight:700, color:'#fff', cursor:'pointer', fontFamily:'inherit', boxShadow:BS.glow }}>
          Crear cuenta con email
        </button>
        <p style={{ textAlign:'center', fontSize:12, color:BS.soft, margin:'4px 0 0' }}>
          Ya tienes cuenta? <span style={{ color:BS.brand, fontWeight:700, cursor:'pointer' }} onClick={onLogin}>Iniciar sesion</span>
        </p>
      </div>
    </div>
  );
    ...
    <div className="bs-fade" style={{ background:BS.bg, minHeight:'100%' }}>
      ...
      <div style={{ padding:'0 16px 16px', background:BS.surface, borderBottom:`1px solid ${BS.border}` }}>
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-end', marginTop:-28, marginBottom:12 }}>
          ...
          <button style={{ padding:'8px 18px', borderRadius:10, border:`1.5px solid ${BS.borderStrong}`, background:BS.surface2, fontSize:13, fontWeight:700, cursor:'pointer', fontFamily:'inherit', color:BS.ink }}>Editar perfil</button>
        </div>
