...
function Process() {
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "process-guarantee reveal", style: { marginTop: 36, textAlign: "center" } }, /* @__PURE__ */ React.createElement("a", { href: "/garantia", className: "btn btn-primary" }, t(["Conoce m\xE1s sobre nuestra garant\xEDa", "Learn more about our guarantee"]), /* @__PURE__ */ React.createElement("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M5 12h14M13 5l7 7-7 7" }))))));
}
const QUIZ_BREEDS = [
  {
    name: "French Bulldog",
...
function Quiz() {
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "quiz-nav" }, /* @__PURE__ */ React.createElement("button", { className: "quiz-back", onClick: back, disabled: step === 0 }, t(STRINGS.quiz.back)), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: "var(--ink-soft)" } }, step + 1, "/4")), /* @__PURE__ */ React.createElement("div", { style: { borderTop: "1px solid var(--line)", marginTop: 18, paddingTop: 14, textAlign: "center" } }, /* @__PURE__ */ React.createElement("a", { href: "/quiz", className: "bp-quiz-cta", style: { fontSize: 13.5, fontWeight: 700 } }, /* @__PURE__ */ React.createElement("span", { className: "bp-shine" }, t(["Haz un quiz m\xE1s completo aqu\xED \u2192", "Take a more complete quiz here \u2192"]))))) : /* @__PURE__ */ React.createElement("div", { className: "quiz-result" }, /* @__PURE__ */ React.createElement("div", { className: "match-pct" }, match.pct, "%"), /* @__PURE__ */ React.createElement("div", { className: "match-lbl" }, t(STRINGS.quiz.matchLbl)), /* @__PURE__ */ React.createElement("h3", null, match.breed.name), /* @__PURE__ */ React.createElement("p", null, t(match.breed.blurb)), /* @__PURE__ */ React.createElement("a", { href: `/blog?art=${match.breed.art}`, style: { fontSize: 14, color: "var(--orange)", fontWeight: 600, display: "inline-flex", alignItems: "center", gap: 6, marginBottom: 8 } }, t(["Conocer m\xE1s sobre esta raza", "Learn more about this breed"]), /* @__PURE__ */ React.createElement("svg", { width: "12", height: "12", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M5 12h14M13 5l7 7-7 7" }))), /* @__PURE__ */ React.createElement("div", { className: "actions" }, /* @__PURE__ */ React.createElement("a", { href: "/cachorros?raza=" + encodeURIComponent(match.breed.name), className: "btn btn-primary" }, t(["Ver " + match.breed.name + " disponibles", "See available " + match.breed.name])), /* @__PURE__ */ React.createElement("button", { className: "btn btn-outline", onClick: reset }, t(STRINGS.quiz.again))), /* @__PURE__ */ React.createElement("a", { href: "/quiz", className: "btn btn-outline", style: { marginTop: 10, fontSize: 13 } }, t(["Hacer un quiz m\xE1s completo (10 preguntas)", "Take a more complete quiz (10 questions)"]))))));
}
