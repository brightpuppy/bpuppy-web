...
function SolicitudPage() {
  const t = useT();
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Header, { overDark: false }), /* @__PURE__ */ React.createElement("main", null, /* @__PURE__ */ React.createElement("section", { style: { background: "var(--dark-sec)", padding: "110px clamp(20px,5vw,80px) 56px", position: "relative", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, backgroundImage: "radial-gradient(70% 80% at 80% 20%, rgba(245,130,32,0.07), transparent 60%)", pointerEvents: "none" } }), /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 700, position: "relative", zIndex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, fontWeight: 700, letterSpacing: "0.16em", textTransform: "uppercase", color: "var(--orange)", marginBottom: 14 } }, t(["BPuppy \xB7 Solicitud", "BPuppy \xB7 Request"])), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: "var(--display)", fontSize: "clamp(40px,7vw,88px)", fontWeight: 800, letterSpacing: "-0.04em", lineHeight: 0.93, margin: "0 0 20px", color: "var(--ink)" } }, t(["Encuentra tu", "Find your"]), /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("em", { style: { fontFamily: "var(--serif)", fontStyle: "italic", color: "var(--orange)" } }, t(["compa\xF1ero ideal.", "ideal companion."]))), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 17, color: "var(--ink-2)", lineHeight: 1.65, maxWidth: "48ch", margin: 0 } }, t(["Si no encontraste lo que buscas en el listado, cu\xE9ntanos qu\xE9 quieres \u2014 te avisamos cuando tengamos al compa\xF1ero perfecto para ti.", "If you didn\u2019t find what you were looking for in our listings, tell us what you want \u2014 we\u2019ll let you know as soon as we have the perfect companion for you."])))), /* @__PURE__ */ React.createElement(SolicitudForm, null)), /* @__PURE__ */ React.createElement(Footer, null));
}
