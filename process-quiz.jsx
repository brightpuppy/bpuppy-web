        ...
        <div className="quiz-card reveal" data-d="2" style={{ position: 'relative' }}>
          ...
          <div className="quiz-result">
              ...
              <div className="actions">
                <a href={'/cachorros?raza=' + encodeURIComponent(match.breed.name)} className="btn btn-primary">{t(['Ver ' + match.breed.name + ' disponibles', 'See available ' + match.breed.name])}</a>
