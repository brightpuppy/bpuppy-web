...
(function () {
  ...
  function build(source) {
    ...
    ov.innerHTML =
      '<div style="background:#fff;color:' + INK + ';max-width:420px;width:100%;border-radius:22px;padding:26px 24px;text-align:center;box-shadow:0 30px 70px rgba(15,25,45,0.30);position:relative" onclick="event.stopPropagation()">' +
        '<button id="bp-si-x" aria-label="Cerrar" style="position:absolute;top:12px;right:12px;width:32px;height:32px;border-radius:50%;border:none;background:#f1f3f7;color:#6b7280;font-size:19px;line-height:1;cursor:pointer">×</button>' +
        '<div style="font-family:\'Bricolage Grotesque\',sans-serif;font-weight:800;font-size:19px;letter-spacing:-0.02em;margin-bottom:6px"><span style="color:' + INK + '">B</span><span style="color:' + ACC + '"> Social</span></div>' +
        '<div style="font-size:10px;font-weight:800;letter-spacing:.18em;text-transform:uppercase;color:' + ACC + ';margin-bottom:12px">' + t("Por invitación · En construcción", "Invite-only · In the works") + '</div>' +
        '<h2 style="margin:0 0 10px;line-height:1.08;font-size:clamp(23px,5.5vw,28px);letter-spacing:-0.02em">' +
          ...
          '<span style="font-family:\'Instrument Serif\',Georgia,serif;font-style:italic;font-weight:400;color:' + ACC + '">' + t("Se está construyendo.", "We’re building it.") + '</span></h2>' +
        '<p style="color:' + MUT + ';font-size:14.5px;line-height:1.6;margin:0 auto 18px;max-width:34ch">' +
