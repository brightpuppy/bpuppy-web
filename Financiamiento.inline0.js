...
const FIN_PLANS = [
  ...
  { id: "pp6", name: "PayPal Credit", sub: "6 pagos \xB7 Sin inter\xE9s", count: 6, apr: 0, color: "#003087", textColor: "#fff", recommended: false },
...
function FinForm() {
  ...
  }, style: { cursor: "pointer" } }, /* @__PURE__ */ React.createElement("option", { value: "Klarna - 4 pagos sin inter\xE9s" }, "Klarna \xB7 4 pagos 0%"), /* @__PURE__ */ React.createElement("option", { value: "PayPal Credit - 6 cuotas sin inter\xE9s" }, "PayPal \xB7 6 cuotas 0%"), /* @__PURE__ */ React.createElement("option", { value: "Affirm - 12 meses" }, "Affirm \xB7 12 meses"), /* @__PURE__ */ React.createElement("option", { value: "Affirm - 24 meses" }, "Affirm \xB7 24 meses"), /* @__PURE__ */ React.createElement("option", { value: "No estoy seguro" }, "No estoy seguro a\xFAn")))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "fin-label" }, "Raza de inter\xE9s"), /* @__PURE__ */ React.createElement("input", { className: "fin-input", placeholder: "Ej. Golden Retriever, Bulldog Franc\xE9s\u2026", value: form.breed, onChange: function(e) {
