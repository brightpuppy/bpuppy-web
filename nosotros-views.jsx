...
const TIMELINE = [
{ year: '2012', city: 'Santo Domingo, RD', emoji: '🇩🇴', title: 'El primer cachorro', body: 'Todo empezó con una camada de Golden Retrievers en Santo Domingo. Sin experiencia formal, con mucho amor y más preguntas que respuestas. El primer hogar que adoptó un cachorro nuestro se convirtió en familia.' },
{ year: '2015', city: 'Santo Domingo, RD', emoji: '🏠', title: 'El primer local', body: 'Abrimos el primer espacio físico dedicado a crianza y adopción responsable. Lo que era informal se convirtió en un proceso: salud verificada, contratos de adopción, seguimiento post-adopción.' },
{ year: '2018', city: 'Miami, FL', emoji: '✈️', title: 'La transición a USA', body: 'Con la familia creciendo y la visión más clara, cruzamos a Miami. El mercado era más exigente, la regulación más estricta y la competencia enorme. Pero también había más familias que buscaban exactamente lo que ofrecemos: cachorros criados en familia, no en jaulas.' },
{ year: '2020', city: 'Miami, FL', emoji: '🌱', title: 'Durante la pandemia', body: 'Cuando el mundo se paralizó, los refugios se vaciaron y las familias buscaban compañía. Facilitamos más de 40 adopciones durante la pandemia, muchas a familias que nunca habían tenido mascotas. Ese año nos confirmó el propósito.' },
{ year: '2022', city: 'Miami, FL', emoji: '✂️', title: 'Abrimos Grooming', body: 'La demanda de familias que querían continuar el cuidado de sus mascotas con nosotros nos llevó a agregar el servicio de grooming profesional. Con productos premium, sin químicos agresivos y con el mismo amor que ponemos en cada cachorro.' },
{ year: '2024', city: 'Miami, FL', emoji: '🌐', title: 'BPuppy Digital', body: 'Lanzamos la plataforma digital: BPuppy Social para la comunidad, el blog educativo, la tienda curada y el sistema de citas de grooming online. El sueño de llevar todo a un solo lugar para las familias que confían en nosotros.' }];


const IMPACT_STORIES = [
{ emoji: '🧩', tag: 'Autismo', title: 'Mateo y su Golden Retriever', body: 'Mateo tiene 7 años y TEA nivel 2. Sus padres buscaban una raza calmada y gentil. Trabajamos con su terapeuta para elegir el cachorro correcto. Seis meses después, su madre nos escribió: "Mateo habla más con el perro que con cualquier persona. Es su mejor amigo."', img: 'nosotros-impact-0' },
{ emoji: '👴', tag: 'Adultos mayores', title: 'Don Carlos, 74 años', body: 'Enviudó en 2021 y vivía solo. Su hija nos contactó buscando compañía para él. Le recomendamos un Cavalier King Charles de 2 años, ya entrenado. Don Carlos nos llama cada mes para contarnos lo que hizo "su perro" esa semana.', img: 'nosotros-impact-1' },
{ emoji: '🏠', tag: 'Refugio', title: 'Visita al Humane Society Miami', body: 'Dos veces al año visitamos el Humane Society of Greater Miami con recursos y apoyo. En nuestra última visita facilitamos la adopción de 8 perros adultos que llevaban meses esperando hogar.', img: 'nosotros-impact-2' },
{ emoji: '🎓', tag: 'Educación', title: 'Taller en Lincoln Marti School', body: 'Llevamos un cachorro a una escuela primaria en Hialeah para una charla sobre responsabilidad animal, empatía y cuidado de mascotas. 120 niños, un cachorro, y muchas lágrimas de emoción de los maestros.', img: 'nosotros-impact-3' }];


const TEAM = [
{ name: 'Placeholder', role: 'Fundador & Criador', emoji: '👤', bio: 'Más de 12 años de experiencia en crianza responsable. Certificado en manejo canino y bienestar animal.', img: 'team-0' },
{ name: 'Placeholder', role: 'Groomer Principal', emoji: '✂️', bio: 'Especialista en grooming asiático y técnicas europeas. 8 años de experiencia con razas de pelo continuo.', img: 'team-1' },
{ name: 'Placeholder', role: 'Coordinadora de Adopciones', emoji: '🤝', bio: 'Psicóloga animal con enfoque en el match perfecto familia-mascota. Cada adopción pasa por su evaluación.', img: 'team-2' },
{ name: 'Placeholder', role: 'Veterinaria de Referencia', emoji: '🩺', bio: 'DVM con especialización en medicina preventiva. Revisa cada cachorro antes de cualquier adopción.', img: 'team-3' }];
...
function ImpactStories() {
  ...
  const story = IMPACT_STORIES[active];
  return (
    <div>
      ...
      <div key={active} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32, alignItems: 'center', animation: 'fadeIn .3s ease' }}>
        ...
        <image-slot id={story.img} shape="rounded" radius="20" placeholder={`Foto: ${story.title}`} style={{ aspectRatio: '1', display: 'block' }} />
      </div>
    </div>);
...
function NosotrosApp() {
  ...
  const TABS = [['historia', '📖 Historia'], ['impacto', '❤️ Impacto Social'], ['equipo', '👥 Equipo'], ['prensa', '📰 Prensa']];
    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
        ...
        <div className="container" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'center' }}>
          <div>
            ...
            <h1 style={{ fontFamily: 'Bricolage Grotesque,sans-serif', fontSize: 'clamp(32px,4.5vw,52px)', fontWeight: 800, color: '#fff', margin: '0 0 16px', letterSpacing: '-0.03em', lineHeight: 1.05 }}>
              De República Dominicana<br />a <em style={{ fontFamily: 'Instrument Serif,Georgia,serif', fontStyle: 'italic', fontWeight: 400, color: 'var(--orange)' }}>Florida</em>
            </h1>
      ...
      <div className="container" style={{ padding: '60px 0 80px' }}>
        ...
        <div>
            ...
            <div style={{ marginTop: 56, padding: '32px', borderRadius: 20, background: 'var(--paper)', boxShadow: '0 2px 24px -8px rgba(45,36,33,0.10)' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(220px,1fr))', gap: 16 }}>
                {[
              ['🧩', 'Programa TEA', 'Matching especializado para familias con niños en el espectro autista. Trabajamos con terapeutas.'],
              ['👴', 'Mascotas para mayores', 'Descuentos especiales para adultos mayores que adoptan. Incluye guía de cuidado simplificada.'],
              ['🏠', 'Visitas a refugios', 'Dos veces al año facilitamos adopciones y donamos recursos a refugios locales en Miami.'],
        ...
        <div>
            ...
            <p style={{ fontSize: 15, color: 'var(--ink-2)', marginBottom: 36 }}>Las personas detrás de cada cachorro feliz.</p>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(240px,1fr))', gap: 24, marginBottom: 48 }}>
              {TEAM.map((member, i) =>
            <div key={i} style={{ background: 'var(--paper)', borderRadius: 20, overflow: 'hidden', boxShadow: '0 2px 16px -4px rgba(45,36,33,0.10)' }}>
                  <image-slot id={member.img} shape="rect" placeholder={`Foto: ${member.role}`} style={{ width: '100%', aspectRatio: '1', display: 'block' }} />
                  <div style={{ padding: '18px 20px' }}>
                    <div style={{ fontSize: 11, fontWeight: 800, color: 'var(--orange)', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 4 }}>{member.role}</div>
                    <div style={{ fontFamily: 'Bricolage Grotesque,sans-serif', fontSize: 18, fontWeight: 800, color: 'var(--ink)', marginBottom: 8 }}>{member.name}</div>
                    <p style={{ fontSize: 13, color: 'var(--ink-2)', lineHeight: 1.6, margin: 0 }}>{member.bio}</p>
                  </div>
                </div>
            )}
            </div>
            <div style={{ background: 'var(--paper)', borderRadius: 20, padding: '32px', border: '1px solid var(--line)' }}>
              ...
              <p style={{ fontSize: 14.5, color: 'var(--ink-2)', margin: '0 0 18px', lineHeight: 1.65 }}>Siempre estamos buscando personas apasionadas por los animales. Grooming, cuidado de cachorros, adoptions coordinator. Escríbenos.</p>
