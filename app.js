...
function App() {
  ...
  return /* @__PURE__ */ React.createElement(LangContext.Provider, { value: { lang, setLang: setLangBoth } }, /* @__PURE__ */ React.createElement(Header, { overDark }), /* @__PURE__ */ React.createElement("main", null, /* @__PURE__ */ React.createElement(Hero, null), /* @__PURE__ */ React.createElement(Gallery, null), /* @__PURE__ */ React.createElement(About, null), /* @__PURE__ */ React.createElement(Process, null), /* @__PURE__ */ React.createElement(Promise_, null), /* @__PURE__ */ React.createElement(Quiz, null), /* @__PURE__ */ React.createElement(InstagramFeed, null), /* @__PURE__ */ React.createElement(Testimonials, null), /* @__PURE__ */ React.createElement(DeliveryMapLive, null), /* @__PURE__ */ React.createElement(FAQ, null), /* @__PURE__ */ React.createElement(FinalCTA, null)), /* @__PURE__ */ React.createElement(Footer, null), /* @__PURE__ */ React.createElement(PawCursor, { enabled: tweaks.paws }), /* @__PURE__ */ React.createElement(BPuppyTweaks, { tweaks, setTweak }));
}
