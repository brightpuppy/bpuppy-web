  ...
  const submitBooking = async () => {
    ...
    try {
      ...
      const res = await fetch("https://oqqwmcplljirbreowrll.supabase.co/functions/v1/grooming_book", {
        ...
        body: JSON.stringify({ pet_name: petName, services: [...selectedServices], amount: total, size, notes, appointment_date, appointment_time: time, client_name: ownerName, phone, email, contact_preference: email ? "email" : "whatsapp", pickup, promo: promoCode }),
      });
