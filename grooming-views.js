...
\u{1F4DE} Tel\xE9fono: ${phone}${promoCode ? "\n\u{1F3AB} C\xF3digo promo: " + promoCode : ""}${notes ? "\n\u{1F4DD} Notas: " + notes : ""}`);
  ...
  )), !activeMembership && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11.5, fontWeight: 700, color: "var(--ink-2)", marginBottom: 4 } }, "C\xF3digo de promoci\xF3n (opcional)"), /* @__PURE__ */ React.createElement("input", { value: promoCode, onChange: (e) => setPromoCode(e.target.value.toUpperCase()), placeholder: "Ej. APERTURA", style: { width: "100%", padding: "11px 14px", borderRadius: 10, border: `1.5px solid ${promoCode ? "var(--orange)" : "var(--line)"}`, background: promoCode ? "rgba(245,130,32,0.06)" : "var(--bg)", fontFamily: "inherit", fontSize: 14, color: "var(--ink)", outline: "none", fontWeight: promoCode ? 700 : 400, letterSpacing: promoCode ? "0.08em" : 0 } }), promoCode === "APERTURA" && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#1EB87A", fontWeight: 700, marginTop: 4 } }, "\u2713 \xA1C\xF3digo de apertura aplicado! Primer ba\xF1o + corte gratis en tu visita.")), planQualifies ? /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, padding: "10px 14px", borderRadius: 10, border: "1.5px solid #1EB87A", background: "rgba(30,184,122,0.08)" } }, /* @__PURE__ */ React.createElement("span", { style: { flexShrink: 0, color: "#1EB87A", display: "inline-flex" } }, /* @__PURE__ */ React.createElement(Icon, { name: activePlan ? activePlan.icon : "trophy", size: 20 })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, fontWeight: 700, color: "var(--ink)" } }, "Miembro ", activeMembership.plan, " \u2014 verificado"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#1EB87A", fontWeight: 600 } }, "Pickup & Delivery gratis + descuentos aplicados"))) : /* @__PURE__ */ React.createElement("button", { onClick: () => setIsMember((m) => !m), style: { display: "flex", alignItems: "center", gap: 10, padding: "10px 14px", borderRadius: 10, border: `1.5px solid ${isMember ? "#1EB87A" : "var(--line)"}`, background: isMember ? "rgba(30,184,122,0.08)" : "var(--bg)", cursor: "pointer", fontFamily: "inherit", width: "100%", textAlign: "left" } }, /* @__PURE__ */ React.createElement("div", { style: { width: 20, height: 20, borderRadius: 4, border: `2px solid ${isMember ? "#1EB87A" : "var(--line)"}`, background: isMember ? "#1EB87A" : "transparent", display: "grid", placeItems: "center", flexShrink: 0, transition: "all .15s" } }, isMember && /* @__PURE__ */ React.createElement("span", { style: { color: "#fff", fontSize: 12, fontWeight: 800 } }, "\u2713")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, fontWeight: 700, color: "var(--ink)" } }, "Soy miembro Plan Total o VIP"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#1EB87A", fontWeight: 600 } }, "Pickup & Delivery gratis en radio de 10 millas")))), bookStatus === "sent" ? /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "8px 4px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: 8, color: "#1EB87A" } }, /* @__PURE__ */ React.createElement(Icon, { name: "check", size: 42 })), /* @__PURE__ */ React.createElement("h3", { style: { fontFamily: "Bricolage Grotesque,sans-serif", fontSize: 19, fontWeight: 800, color: "var(--ink)", margin: "0 0 6px" } }, "\xA1Solicitud recibida!"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 13, color: "var(--ink-2)", lineHeight: 1.55, margin: "0 0 14px" } }, "Recibimos tu cita para ", /* @__PURE__ */ React.createElement("strong", null, petName), ". Te confirmamos disponibilidad en menos de 2 horas en horario laboral", me && me.email ? /* @__PURE__ */ React.createElement(React.Fragment, null, " al correo ", /* @__PURE__ */ React.createElement("strong", null, me.email)) : "", "."), /* @__PURE__ */ React.createElement("a", { href: buildWhatsApp(), target: "_blank", rel: "noopener noreferrer", style: { display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 8, padding: "12px 22px", borderRadius: 14, background: "#25D366", color: "#fff", fontFamily: "inherit", fontSize: 14, fontWeight: 700, textDecoration: "none" } }, /* @__PURE__ */ React.createElement(Icon, { name: "chat", size: 18, color: "#fff" }), " Enviar tambi\xE9n por WhatsApp")) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setStep(2), style: { flex: 1, padding: "13px", borderRadius: 14, border: "1.5px solid var(--line)", background: "none", fontFamily: "inherit", fontSize: 14, fontWeight: 600, color: "var(--ink-2)", cursor: "pointer" } }, "\u2190 Atr\xE1s"), /* @__PURE__ */ React.createElement("button", { onClick: submitBooking, disabled: !canConfirm || bookStatus === "sending", style: { flex: 2, padding: "13px", borderRadius: 14, border: "none", background: canConfirm ? "var(--orange)" : "var(--line)", color: canConfirm ? "#fff" : "var(--ink-2)", fontFamily: "inherit", fontSize: 14, fontWeight: 700, cursor: canConfirm && bookStatus !== "sending" ? "pointer" : "default", transition: "all .2s" } }, bookStatus === "sending" ? "Enviando\u2026" : "Confirmar cita")), bookStatus === "error" && /* @__PURE__ */ React.createElement("p", { style: { fontSize: 12.5, color: "#C0392B", textAlign: "center", margin: "10px 0 0" } }, bookErr), !canConfirm && /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, color: "var(--orange)", textAlign: "center", margin: "8px 0 0" } }, "Completa mascota, nombre y tel\xE9fono para confirmar"), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", margin: "10px 0 0" } }, /* @__PURE__ */ React.createElement("a", { href: canConfirm ? buildWhatsApp() : "#", target: "_blank", rel: "noopener noreferrer", style: { fontSize: 12.5, fontWeight: 700, color: canConfirm ? "#1EB87A" : "var(--ink-soft)", textDecoration: "none", pointerEvents: canConfirm ? "all" : "none", display: "inline-flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement(Icon, { name: "chat", size: 15 }), " \xBFPrefieres WhatsApp? Env\xEDalo por aqu\xED")), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 10.5, color: "var(--ink-soft)", textAlign: "center", margin: "10px 0 0" } }, "Recibir\xE1s confirmaci\xF3n en menos de 2 horas en horario laboral"))));
}
