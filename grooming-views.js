...
\u{1F4DE} Tel\xE9fono: ${phone}${promoCode ? "\n\u{1F3AB} C\xF3digo promo: " + promoCode : ""}${notes ? "\n\u{1F4DD} Notas: " + notes : ""}`);
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { background: "var(--paper)", borderRadius: 24, padding: "24px", boxShadow: "0 4px 32px -8px rgba(45,36,33,0.12)" } }, me ? /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", borderRadius: 12, background: "rgba(245,130,32,0.07)", border: "1px solid rgba(245,130,32,0.22)", marginBottom: 16 } }, /* @__PURE__ */ React.createElement("span", { style: { width: 30, height: 30, borderRadius: "50%", background: "var(--orange)", color: "#fff", display: "inline-flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 800, flexShrink: 0 } }, (firstName || "?")[0]), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, fontWeight: 700, color: "var(--ink)" } }, "Reservando como ", firstName || "cliente"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--ink-2)" } }, activePlan ? `${activePlan.emoji} ${activeMembership.plan}` : "Sin plan activo", pets.length ? ` \xB7 ${pets.length} ${pets.length === 1 ? "mascota" : "mascotas"}` : "")), planQualifies && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10.5, fontWeight: 800, color: "#1EB87A", background: "rgba(30,184,122,0.1)", borderRadius: 999, padding: "4px 10px", whiteSpace: "nowrap" } }, "\u2713 Pickup gratis")) : /* @__PURE__ */ React.createElement("button", { onClick: () => onLogin && onLogin(), style: { display: "flex", alignItems: "center", gap: 10, width: "100%", textAlign: "left", padding: "10px 12px", borderRadius: 12, background: "var(--bg)", border: "1px dashed var(--line)", cursor: "pointer", fontFamily: "inherit", marginBottom: 16 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 18, flexShrink: 0 } }, "\u{1F44B}"), /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, fontWeight: 700, color: "var(--ink)" } }, "\xBFYa eres cliente? Entra r\xE1pido"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--ink-2)" } }, "Autocompletamos tus datos y ver\xE1s los beneficios de tu plan")), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, fontWeight: 800, color: "var(--orange)", whiteSpace: "nowrap" } }, "Entrar \u2192")), /* @__PURE__ */ React.createElement(StepDots, null), step === 1 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 700, color: "var(--ink)", marginBottom: 8 } }, "Tama\xF1o de tu mascota"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 6 } }, [["Peque\xF1o", "<15lb"], ["Mediano", "15-40"], ["Grande", "40-70"], ["XL", "70+"]].map(([s, sub]) => /* @__PURE__ */ React.createElement("button", { key: s, onClick: () => setSize(s), style: { padding: "8px 4px", borderRadius: 10, border: `2px solid ${size === s ? "var(--orange)" : "var(--line)"}`, background: size === s ? "rgba(245,130,32,0.07)" : "var(--bg)", cursor: "pointer", fontFamily: "inherit", transition: "all .15s", textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 700, color: "var(--ink)" } }, s), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "var(--ink-soft)" } }, sub))))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 700, color: "var(--ink)", marginBottom: 8 } }, "Selecciona uno o m\xE1s servicios"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 8, marginBottom: 14 } }, SERVICES.map((sv) => {
    ...
    ["Tu nombre \u{1F464}", ownerName, setOwnerName, "Nombre completo"],
    ["Tel\xE9fono \u{1F4DE}", phone, setPhone, "+1 (305) 000-0000"]
  ...
  )), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11.5, fontWeight: 700, color: "var(--ink-2)", marginBottom: 4 } }, "\u{1F3AB} C\xF3digo de promoci\xF3n (opcional)"), /* @__PURE__ */ React.createElement("input", { value: promoCode, onChange: (e) => setPromoCode(e.target.value.toUpperCase()), placeholder: "Ej. APERTURA", style: { width: "100%", padding: "11px 14px", borderRadius: 10, border: `1.5px solid ${promoCode ? "var(--orange)" : "var(--line)"}`, background: promoCode ? "rgba(245,130,32,0.06)" : "var(--bg)", fontFamily: "inherit", fontSize: 14, color: "var(--ink)", outline: "none", fontWeight: promoCode ? 700 : 400, letterSpacing: promoCode ? "0.08em" : 0 } }), promoCode === "APERTURA" && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#1EB87A", fontWeight: 700, marginTop: 4 } }, "\u2713 \xA1C\xF3digo de apertura aplicado! Primer ba\xF1o + corte gratis en tu visita.")), planQualifies ? /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, padding: "10px 14px", borderRadius: 10, border: "1.5px solid #1EB87A", background: "rgba(30,184,122,0.08)" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 18, flexShrink: 0 } }, activePlan ? activePlan.emoji : "\u{1F3C6}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, fontWeight: 700, color: "var(--ink)" } }, "Miembro ", activeMembership.plan, " \u2014 verificado"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#1EB87A", fontWeight: 600 } }, "Pickup & Delivery gratis + descuentos aplicados"))) : /* @__PURE__ */ React.createElement("button", { onClick: () => setIsMember((m) => !m), style: { display: "flex", alignItems: "center", gap: 10, padding: "10px 14px", borderRadius: 10, border: `1.5px solid ${isMember ? "#1EB87A" : "var(--line)"}`, background: isMember ? "rgba(30,184,122,0.08)" : "var(--bg)", cursor: "pointer", fontFamily: "inherit", width: "100%", textAlign: "left" } }, /* @__PURE__ */ React.createElement("div", { style: { width: 20, height: 20, borderRadius: 4, border: `2px solid ${isMember ? "#1EB87A" : "var(--line)"}`, background: isMember ? "#1EB87A" : "transparent", display: "grid", placeItems: "center", flexShrink: 0, transition: "all .15s" } }, isMember && /* @__PURE__ */ React.createElement("span", { style: { color: "#fff", fontSize: 12, fontWeight: 800 } }, "\u2713")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, fontWeight: 700, color: "var(--ink)" } }, "Soy miembro Plan Total o VIP"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#1EB87A", fontWeight: 600 } }, "Pickup & Delivery gratis en radio de 10 millas")))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setStep(2), style: { flex: 1, padding: "13px", borderRadius: 14, border: "1.5px solid var(--line)", background: "none", fontFamily: "inherit", fontSize: 14, fontWeight: 600, color: "var(--ink-2)", cursor: "pointer" } }, "\u2190 Atr\xE1s"), /* @__PURE__ */ React.createElement("a", { href: canConfirm ? buildWhatsApp() : "#", target: "_blank", rel: "noopener noreferrer", style: { flex: 2, padding: "13px", borderRadius: 14, background: canConfirm ? "#25D366" : "var(--line)", color: canConfirm ? "#fff" : "var(--ink-2)", fontFamily: "inherit", fontSize: 14, fontWeight: 700, textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, pointerEvents: canConfirm ? "all" : "none", transition: "all .2s" } }, "\u{1F4AC} Confirmar por WhatsApp")), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 10.5, color: "var(--ink-soft)", textAlign: "center", margin: "10px 0 0" } }, "Recibir\xE1s confirmaci\xF3n en menos de 2 horas en horario laboral")));
}
