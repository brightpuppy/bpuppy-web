...
function GatosEntregadosRoot() {
  ...
  } } }, /* @__PURE__ */ React.createElement(Header, { overDark: false }), /* @__PURE__ */ React.createElement("main", null, /* @__PURE__ */ React.createElement(GatosEntregados, null), /* @__PURE__ */ React.createElement("section", { style: { background: "var(--cat-light,#F3EEFA)", padding: "64px clamp(20px,5vw,80px)", textAlign: "center", borderTop: "1px solid rgba(124,92,191,0.15)" } }, /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 640, margin: "0 auto" } }, /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--display)", fontSize: "clamp(26px,4vw,40px)", fontWeight: 700, color: "var(--ink)", margin: "0 0 10px" } }, "\xBFQuieres tu propio gatito?"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 16, color: "var(--ink-2)", margin: "0 0 24px", lineHeight: 1.6 } }, "Cu\xE9ntanos qu\xE9 buscas y te ayudamos a encontrar tu compa\xF1ero felino ideal."), /* @__PURE__ */ React.createElement("a", { href: "/solicitud", style: { display: "inline-block", background: "var(--cat-purple)", color: "#fff", padding: "14px 30px", borderRadius: 999, fontWeight: 700, fontSize: 15, textDecoration: "none" } }, "Solicita un gatito")))), /* @__PURE__ */ React.createElement(Footer, null));
}
