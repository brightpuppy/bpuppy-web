...
function PublishApp() {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { minHeight: "100vh", display: "flex", flexDirection: "column" } }, /* @__PURE__ */ React.createElement("div", { style: {
    ...
    justifyContent: "space-between",
    gap: 16
  } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 16 } }, /* @__PURE__ */ React.createElement("a", { href: "Home.html" }, /* @__PURE__ */ React.createElement("img", { src: "assets/logo-clean-light.png", style: { height: 26, display: "block" }, alt: "BPuppy" })), /* @__PURE__ */ React.createElement("div", { style: { width: 1, height: 22, background: "rgba(255,255,255,0.1)" } }), /* @__PURE__ */ React.createElement("span", { style: {
    fontSize: 11,
    fontWeight: 700,
