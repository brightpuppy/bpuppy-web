...
(function(w) {
  ...
  var REGISTRY = {
    pages: [
      { id:'Home',         label:'Inicio',          url:'Home.html',         category:'Principal' },
      { id:'Cachorros',              label:'Cachorros',              url:'Cachorros.html',            category:'Principal' },
      { id:'Cachorros-Entregados',   label:'Cachorros Entregados',   url:'Cachorros-Entregados.html', category:'Principal' },
      { id:'Gatos-Entregados',       label:'Gatos Entregados',       url:'Gatos-Entregados.html',     category:'Servicios' },
      { id:'Adopciones',             label:'Adopciones',             url:'Adopciones.html',           category:'Principal' },
      { id:'Tienda',       label:'Tienda',           url:'Tienda.html',       category:'Principal' },
      { id:'Media',        label:'Media',            url:'Media.html',        category:'Contenido' },
      { id:'Blog',         label:'Blog',             url:'Blog.html',         category:'Contenido' },
      { id:'Social',       label:'Social',           url:'Social.html',       category:'Contenido' },
      { id:'Grooming',     label:'Grooming',         url:'Grooming.html',     category:'Servicios' },
      { id:'Gatos',        label:'Gatos',            url:'Gatos.html',        category:'Servicios' },
      { id:'Razas-Perros', label:'Razas de Perros',  url:'Razas-Perros.html', category:'Info'      },
      { id:'Razas-Gatos',  label:'Razas de Gatos',   url:'Razas-Gatos.html',  category:'Info'      },
      { id:'Nosotros',     label:'Nosotros',         url:'Nosotros.html',     category:'Info'      },
      { id:'Historia',     label:'Historia',         url:'Historia.html',     category:'Info'      },
    ],
    sections: {
