...
function CreateProfileScreen({ me, onSave, onLogout }) {
  ...
  const save = async () => {
    ...
    if (u.length < 3) {
      setErr("Elige un usuario de al menos 3 caracteres");
      return;
    }
    setBusy(true);
    setErr("");
    try {
      ...
      if (!(d && d.ok)) {
        setErr(d && d.error || "No se pudo guardar (\xBFusuario ya tomado?)");
        setBusy(false);
      }
    } catch (_e) {
      setErr("Error de red");
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "bs-fade", style: { padding: "40px 24px 28px", minHeight: "100%", background: BS.bg } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "Bricolage Grotesque,sans-serif", fontSize: 25, fontWeight: 800, color: BS.ink, letterSpacing: "-0.03em", marginBottom: 6 } }, "Crea tu perfil"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 13, color: BS.ink2, lineHeight: 1.5, margin: "0 0 20px" } }, "Bienvenido", me && me.email ? " \xB7 " + me.email : "", ". As\xED te ver\xE1 la comunidad."), /* @__PURE__ */ React.createElement("div", { style: lbl }, "Nombre de usuario *"), /* @__PURE__ */ React.createElement("input", { value: username, onChange: (e) => setUsername(e.target.value), placeholder: "ej: lunaygolden", style: fld }), /* @__PURE__ */ React.createElement("div", { style: lbl }, "Ciudad"), /* @__PURE__ */ React.createElement("input", { value: city, onChange: (e) => setCity(e.target.value), placeholder: "Miami, FL", style: fld }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Mascota"), /* @__PURE__ */ React.createElement("input", { value: petName, onChange: (e) => setPetName(e.target.value), placeholder: "Luna", style: fld })), /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Raza"), /* @__PURE__ */ React.createElement("input", { value: petBreed, onChange: (e) => setPetBreed(e.target.value), placeholder: "Golden", style: fld }))), /* @__PURE__ */ React.createElement("div", { onClick: () => setIsPublic((v) => !v), style: { display: "flex", alignItems: "center", gap: 12, padding: "12px 14px", borderRadius: 12, border: `1.5px solid ${isPublic ? BS.brand : BS.border}`, background: isPublic ? "rgba(14,165,233,0.07)" : BS.surface2, cursor: "pointer", marginBottom: 4 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13.5, fontWeight: 700, color: BS.ink } }, "Perfil p\xFAblico"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11.5, color: BS.soft, lineHeight: 1.45 } }, "Aparece en Comunidad con tu usuario, ciudad y tu mascota. Nunca tu correo. Puedes cambiarlo cuando quieras.")), /* @__PURE__ */ React.createElement("div", { style: { width: 46, height: 26, borderRadius: 999, background: isPublic ? BS.grad : BS.border, position: "relative", flexShrink: 0 } }, /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", top: 3, left: isPublic ? 23 : 3, width: 20, height: 20, borderRadius: "50%", background: "#fff", transition: "left .2s" } }))), err && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, color: BS.like, fontWeight: 600, marginTop: 8 } }, err), /* @__PURE__ */ React.createElement("button", { onClick: save, disabled: busy, className: "bs-btn", style: { width: "100%", marginTop: 16, padding: "15px", borderRadius: 14, border: "none", background: BS.grad, color: "#fff", fontSize: 15, fontWeight: 700, cursor: busy ? "default" : "pointer", fontFamily: "inherit", boxShadow: BS.glow, opacity: busy ? 0.7 : 1 } }, busy ? "Guardando\u2026" : "Entrar a la comunidad"), /* @__PURE__ */ React.createElement("button", { onClick: onLogout, className: "bs-btn", style: { width: "100%", marginTop: 10, padding: "12px", borderRadius: 12, border: "none", background: "transparent", color: BS.soft, fontSize: 13, fontWeight: 600, cursor: "pointer", fontFamily: "inherit" } }, "Usar otra cuenta"));
}
...
function StoriesBar() {
  const BS = useBS();
  return /* @__PURE__ */ React.createElement("div", { style: { background: BS.surface, borderBottom: `1px solid ${BS.border}` } }, /* @__PURE__ */ React.createElement("div", { className: "bs-hscr", style: { display: "flex", gap: 12, padding: "12px 14px" } }, BSDATA.stories.map((s) => /* @__PURE__ */ React.createElement("div", { key: s.id, style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 5, cursor: "pointer", flexShrink: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { padding: s.hasNew ? 2.5 : 2, borderRadius: "50%", background: s.hasNew ? BS.grad : BS.border } }, /* @__PURE__ */ React.createElement("div", { style: { width: 50, height: 50, borderRadius: "50%", background: s.isOwn ? BS.bg : s.color, display: "grid", placeItems: "center", border: `2.5px solid ${BS.bg}` } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: s.isOwn ? 20 : 17, fontWeight: 700, color: s.isOwn ? BS.brand : "#fff", fontFamily: "Plus Jakarta Sans,sans-serif" } }, s.initials))), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 9.5, color: s.hasNew ? BS.ink : BS.soft, fontWeight: s.hasNew ? 600 : 400, maxWidth: 56, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" } }, s.username)))));
}
...
function UploadScreen({ setScreen }) {
  ...
  const startScan = () => {
    ...
    setTimeout(() => setScanState("approved"), 2800);
  };
  return /* @__PURE__ */ React.createElement("div", { className: "bs-fade", style: { background: BS.bg, minHeight: "100%", display: "flex", flexDirection: "column" } }, /* @__PURE__ */ React.createElement("div", { style: { background: BS.surface, padding: "12px 16px", display: "flex", alignItems: "center", gap: 12, borderBottom: `1px solid ${BS.border}`, position: "sticky", top: 0, zIndex: 10 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => step > 0 ? setStep((s) => s - 1) : setScreen("feed"), className: "bs-btn", style: { color: BS.ink2, fontSize: 18 } }, step === 0 ? "X" : "<"), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "Bricolage Grotesque,sans-serif", fontSize: 17, fontWeight: 700, color: BS.ink, flex: 1 } }, ["Nueva publicacion", "Agregar detalles", "Verificando...", "Listo!"][step]), step === 1 && /* @__PURE__ */ React.createElement("button", { onClick: startScan, className: "bs-btn", style: { background: BS.grad, color: "#fff", border: "none", padding: "7px 16px", borderRadius: 9, fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" } }, "Publicar")), step === 0 && /* @__PURE__ */ React.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24, gap: 16 } }, /* @__PURE__ */ React.createElement("div", { onClick: () => setStep(1), style: { width: "100%", aspectRatio: "1", maxWidth: 280, borderRadius: 20, border: `2px dashed ${BS.borderStrong}`, background: BS.surface, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", cursor: "pointer", gap: 14 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 64, height: 64, borderRadius: 20, background: BS.surface2, display: "grid", placeItems: "center", fontSize: 28 } }, "\u{1F4F7}"), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, fontWeight: 700, color: BS.ink } }, "Sube tu foto o video"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: BS.soft, marginTop: 3 } }, "JPG, PNG, MP4"))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, width: "100%", maxWidth: 280 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setStep(1), className: "bs-btn", style: { flex: 1, padding: "13px", borderRadius: 14, border: "none", background: BS.grad, color: "#fff", fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" } }, "Galeria"), /* @__PURE__ */ React.createElement("button", { onClick: () => setStep(1), className: "bs-btn", style: { flex: 1, padding: "13px", borderRadius: 14, border: `1.5px solid ${BS.borderStrong}`, background: BS.surface, color: BS.ink, fontSize: 14, fontWeight: 600, cursor: "pointer", fontFamily: "inherit" } }, "Camara"))), step === 1 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 12, padding: "14px 16px", alignItems: "flex-start", borderBottom: `1px solid ${BS.border}`, background: BS.surface } }, /* @__PURE__ */ React.createElement("img", { src: DEMO, alt: "", style: { width: 70, height: 70, objectFit: "cover", borderRadius: 12 } }), /* @__PURE__ */ React.createElement("textarea", { value: caption, onChange: (e) => setCaption(e.target.value), placeholder: "Escribe un pie de foto...", style: { flex: 1, border: "none", background: "none", resize: "none", fontSize: 14, color: BS.ink, lineHeight: 1.55, minHeight: 80, padding: 0 } })), /* @__PURE__ */ React.createElement("div", { style: { padding: "14px 16px", background: BS.surface, marginTop: 8 } }, [["public", "Publico", "Todos pueden ver"], ["pack", "Solo mi Pack", "Solo mis amigos"], ["private", "Privado", "Solo yo"]].map(([v, l, sub]) => /* @__PURE__ */ React.createElement("div", { key: v, onClick: () => setVis(v), style: { display: "flex", alignItems: "center", gap: 12, padding: "10px 14px", borderRadius: 12, border: `1.5px solid ${vis === v ? BS.brand : BS.border}`, background: vis === v ? "rgba(255,85,32,0.07)" : BS.surface2, cursor: "pointer", marginBottom: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13.5, fontWeight: 700, color: BS.ink } }, l), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11.5, color: BS.soft } }, sub)), /* @__PURE__ */ React.createElement("div", { style: { width: 18, height: 18, borderRadius: "50%", border: `2px solid ${vis === v ? BS.brand : BS.borderStrong}`, background: vis === v ? BS.brand : "transparent", display: "grid", placeItems: "center" } }, vis === v && /* @__PURE__ */ React.createElement("div", { style: { width: 7, height: 7, borderRadius: "50%", background: "#fff" } })))))), step === 2 && /* @__PURE__ */ React.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 28, gap: 22 } }, /* @__PURE__ */ React.createElement("div", { style: { position: "relative", width: "100%", maxWidth: 240, borderRadius: 20, overflow: "hidden" } }, /* @__PURE__ */ React.createElement("img", { src: DEMO, alt: "", style: { width: "100%", aspectRatio: "1", objectFit: "cover", display: "block" } }), scanState === "scanning" && /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, background: "rgba(0,0,0,0.2)" } }, /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", left: 0, right: 0, height: 3, background: BS.brand, boxShadow: `0 0 18px ${BS.brand}`, animation: "bsScan 1.1s ease-in-out infinite" } })), scanState === "approved" && /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, background: "rgba(0,232,122,0.14)", display: "grid", placeItems: "center" } }, /* @__PURE__ */ React.createElement("div", { className: "bs-pop", style: { background: "rgba(0,232,122,0.9)", borderRadius: "50%", width: 56, height: 56, display: "grid", placeItems: "center" } }, /* @__PURE__ */ React.createElement("svg", { width: "28", height: "28", viewBox: "0 0 24 24", fill: "none", stroke: "white", strokeWidth: "3", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M20 6L9 17l-5-5" }))))), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, scanState === "scanning" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 16, fontWeight: 700, color: BS.ink, marginBottom: 6 } }, "Verificando contenido..."), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: BS.soft } }, "Nuestro AI revisa que todo sea seguro")), scanState === "approved" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 17, fontWeight: 800, color: BS.online, marginBottom: 5 } }, "Contenido aprobado"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: BS.soft, marginBottom: 22 } }, "Todo listo para compartir"), /* @__PURE__ */ React.createElement("button", { onClick: async () => {
    const A = window.BSAUTH || {};
    if (A.createPost) {
      try {
        await A.createPost({ caption, media_url: "https://bpuppy.us/assets/photos/g04.webp", visibility: vis });
      } catch (e) {
      }
    }
    setScreen("feed");
  }, className: "bs-btn", style: { padding: "14px 44px", borderRadius: 14, border: "none", background: BS.grad, color: "#fff", fontSize: 15, fontWeight: 700, cursor: "pointer", fontFamily: "inherit", boxShadow: BS.glow, animation: "bsPop 0.45s 0.15s both" } }, "Publicar ahora")))));
}
function PetsScreen() {
  const BS = useBS();
...
function CommunityScreen() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "bs-fade", style: { background: BS.bg, minHeight: "100%" } }, /* @__PURE__ */ React.createElement(ScreenHeader, { title: "Comunidad", sub: "Due\xF1os que comparten su perfil p\xFAblico" }), /* @__PURE__ */ React.createElement("div", { style: { margin: "12px 16px", padding: "10px 13px", borderRadius: 12, background: "rgba(14,165,233,0.08)", border: `1px solid ${BS.borderStrong}`, fontSize: 11.5, color: BS.ink2, lineHeight: 1.5 } }, "Tu perfil es ", /* @__PURE__ */ React.createElement("b", { style: { color: BS.ink } }, "privado por defecto"), ". Solo apareces aqu\xED si activas \u201Cperfil p\xFAblico\u201D en tu perfil, y solo con los datos que t\xFA elijas."), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(150px,1fr))", gap: 12, padding: "4px 16px 22px" } }, BSDATA.community.map((m) => {
    const fol = following.has(m.id);
    return /* @__PURE__ */ React.createElement("div", { key: m.id, className: "bs-pop", style: { background: BS.surface, borderRadius: 18, overflow: "hidden", border: `1px solid ${BS.border}` } }, /* @__PURE__ */ React.createElement("div", { style: { height: 84, position: "relative" } }, /* @__PURE__ */ React.createElement("img", { src: m.pet.img, alt: "", style: { width: "100%", height: "100%", objectFit: "cover", display: "block" }, loading: "lazy" }), m.bpuppy && /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", top: 8, left: 8, background: BS.grad, color: "#fff", fontSize: 9, fontWeight: 800, padding: "2px 8px", borderRadius: 999 } }, "BrightPuppy")), /* @__PURE__ */ React.createElement("div", { style: { padding: "0 13px 13px", marginTop: -22, textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { width: 46, height: 46, borderRadius: "50%", background: m.color, display: "grid", placeItems: "center", color: "#fff", fontWeight: 800, fontSize: 16, border: `3px solid ${BS.surface}`, margin: "0 auto 6px" } }, m.initials), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13.5, fontWeight: 800, color: BS.ink } }, m.username), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: BS.soft, marginBottom: 4 } }, m.city), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: BS.brand, fontWeight: 700, background: "rgba(14,165,233,0.1)", borderRadius: 999, padding: "2px 9px", display: "inline-block", marginBottom: 9 } }, m.pet.name, " \xB7 ", m.pet.breed), /* @__PURE__ */ React.createElement("button", { onClick: () => toggle(m.id), className: "bs-btn", style: { width: "100%", padding: "7px", borderRadius: 9, border: `1.5px solid ${fol ? BS.border : BS.brand}`, background: fol ? "transparent" : BS.grad, color: fol ? BS.soft : "#fff", fontSize: 12, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" } }, fol ? "Siguiendo" : "+ Seguir")));
  })));
}
