...
function UploadScreen({ setScreen }) {
  ...
  const doPublish = async () => {
    ...
    try {
      ...
      if (A.createPost) {
        const d = await A.createPost({ caption, media_url: mediaUrl, visibility: vis });
