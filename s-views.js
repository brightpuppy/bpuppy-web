...
function WelcomeScreen({ onSendLink }) {
  ...
  ), err && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, color: BS.like, fontWeight: 600 } }, err), /* @__PURE__ */ React.createElement("button", { onClick: send, disabled: busy, className: "bs-btn bs-rainbow", style: { "--bsr-fill": BS.grad, padding: "15px", fontSize: 15, fontWeight: 800, cursor: busy ? "default" : "pointer", fontFamily: "inherit", boxShadow: BS.glow, opacity: busy ? 0.7 : 1 } }, busy ? "Enviando\u2026" : "Enviarme mi enlace m\xE1gico"), /* @__PURE__ */ React.createElement("p", { style: { textAlign: "center", fontSize: 11.5, color: BS.soft, margin: "4px 0 0", lineHeight: 1.5 } }, "Sin contrase\xF1as. Usa el mismo correo de tu cuenta BrightPuppy si ya eres cliente.")), /* @__PURE__ */ React.createElement("a", { href: "/", className: "bs-btn", style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 7, marginTop: 4, padding: "11px", borderRadius: 12, textDecoration: "none", color: BS.soft, fontSize: 13, fontWeight: 600 } }, /* @__PURE__ */ React.createElement("svg", { width: "15", height: "15", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.2", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M19 12H5" }), /* @__PURE__ */ React.createElement("path", { d: "M12 19l-7-7 7-7" })), "Volver a la p\xE1gina web")));
}
...
function CreateProfileScreen({ me, onSave, onLogout, onDone }) {
  ...
  const save = async () => {
    ...
    if (!editing && !birthdate) {
      setErr("Ingresa tu fecha de nacimiento para continuar");
      return;
    }
    if (birthdate) {
      const a = ageY(birthdate);
      if (a !== null && a < 18) {
        setErr("Para crear un perfil en B Social debes tener 18 a\xF1os o m\xE1s. \xA1Pero puedes seguir jugando y guardar tu puntaje en el juego!");
        return;
      }
    }
    setBusy(true);
